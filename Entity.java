...
public abstract class Entity {
    ...
    public boolean isCollidingWith(Entity other){
        if(other.y + other.getHeight() < this.y){
            return false;
        }
        ...
        if(other.x + this.getWidth() < this.x){
            return false;
        }
        else{
            return true;
    ...
    public boolean frontIsCollidingWith(Entity other){
        if(other.y + other.getHeight() < this.y){
            return false;
        }
        ...
        if(other.x + other.getWidth() < this.x + this.width - 5){
            return false;
        }
        return true;
        // else{
        //     if (this.x + this.getWidth() - 5 >= other.getX() && this.x + this.getWidth() <= other.getX() + 20){
